...
/*showDialog(
  ...
  showExitDialog({
    ...
    required void Function() onNegativeClick,
      ...
      CustomDialog().showCustomDialog(
        topIcon: ImagePath.exitDialogImage,
        dialogTitle: dialogTitle ?? MyString.exitDialogTitle,
        dialogBody: dialogBody ?? MyString.exitDialogBody,
        onPositiveClick: onPositiveClick,
        onNegativeClick: onNegativeClick,
        height: height,
        bottomColor: bottomColor,
        ...
        titleStyle: titleStyle,
        titleWidget: titleWidget,
        topColor: topColor, context: context,
        //   onPositiveClick: () {
  ...
  showNoInternetDialog({
    ...
    required void Function() onNegativeClick,
      ...
      CustomDialog().showCustomDialog(
        height: 380.h,
        topIcon: ImagePath.noInternetImage,
        dialogTitle: dialogTitle ?? MyString.noInternetTitle,
        dialogBody: dialogBody ?? MyString.noInternetBody,
        bottomColor: bottomColor,
        bodyWidget: bodyWidget,
        bodyStyle: bodyStyle,
        negativeButtonText: negativeButtonText,
        ...
        topColor: topColor,
        onPositiveClick: onPositiveClick,
        onNegativeClick: onNegativeClick, context: context,
      );
  ...
  showUpdateDialog(
          ...
          Color? barrierColor,
          Duration? transitionDuration}) =>
      CustomDialog().showBottomDialog(context: context,
          barrierDismissible: barrierDismissible,
          body: body,
