...
import 'package:bloc_base_structure/Elements/Widgets/Dialog/custom_dialog.dart';
import 'package:bloc_base_structure/Elements/Widgets/Dialog/update_dialog.dart';
...
import '../../Models/AdsModels/AdsCount/ads_count.dart';
import '../../Models/AppData/app_data.dart';
...
class Utils {
  ...
  static Future checkInternet({required BuildContext context}) async {
      ...
      await CustomDialog().showNoInternetDialog(
        ...
        onPositiveClick: () async {
          if(isInternetAvailable){
            ...
            Navigator.of(context).pop(true);
            await checkInternet(context: context);
          }
        },
        onNegativeClick: () {
